...
\begin{tikzpicture}[
  ...
  % Doubly thick blue line joining Server Node with Gateway (Double Backhaul Link style)
  ...
  \begin{scope}[x={(1cm,0cm)}, y={(0cm,1cm)}, z={(0cm,0cm)}, shift={(3.8cm, 6.2cm)}, scale=0.85]
    ...
    % Server Backhaul Link (Double Line)
    \draw[double=skyblueserver!20, double distance=1.8pt, line width=0.8pt, skyblueserver!80!black]
      (0, -0.3) -- (0.8, -0.3);
    \node[anchor=west, font=\tiny\sffamily] at (1.0, -0.3) {Server Backhaul Link};
